...
public class GpService extends Service<GpConfiguration> {
    ...
    public void run(GpConfiguration configuration, Environment environment) throws Exception {
        ...
        environment.addResource(new GpResource(dbi, client,
                descobertaServico.getDescobridorServico(configuration.getServicoEndereco()),
                descobertaServico.getDescobridorServico(configuration.getServicoContato()),
                descobertaServico.getDescobridorServico(configuration.getServicoCobranca()),
                descobertaServico.getDescobridorServico(configuration.getServicoWebsiteDivulgacao()),
                descobertaServico.getDescobridorServico(configuration.getServicoWebsiteForum()),
                descobertaServico.getDescobridorServico(configuration.getServicoWebsitePessoal())));
    }
